...
To use these stylesheets, rename the files and wf_theme with the name of your theme.
...
wf_theme-alpha-default-narrow.css  
...
wf_theme-alpha-default-normal.css
...
wf_theme-alpha-default-wide.css
